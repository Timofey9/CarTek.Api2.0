...
namespace CarTek.Api.Controllers
{
    ...
    public class UtilsController : ControllerBase
    {
        ...
        {
            var result = _clientService.CreateClient(model.ClientName, model.Inn, model.ClientAddress, model.ClientUnit, model.FixedPrice, model.Density);
        ...
        {
            var result = _clientService.UpdateClient(model.Id, model.ClientName, model.Inn, model.ClientAddress, model.ClientUnit, model.FixedPrice, model.Density);
